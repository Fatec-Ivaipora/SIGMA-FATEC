...
export default function CadastroAvaliadorPage() {
  return (
    <AuthSplitLayout
      backHref="/login"
      headline="Inscreva-se em eventos, avalie trabalhos e oriente alunos da Fatec Ivaiporã."
    >
      ...
      <form className="mt-8 flex flex-col gap-5">
        ...
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            name="email"
            autoComplete="email"
            placeholder="voce@fatecivaipora.com.br"
            className="rounded-xl border border-fatec-line bg-white px-4 py-2.5 text-sm text-fatec-ink placeholder:text-fatec-muted/70 outline-none transition-colors focus:border-fatec-sky-600"
          />
        </label>
